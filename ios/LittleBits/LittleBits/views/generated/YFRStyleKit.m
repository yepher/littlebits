        ...
        //// Variables Infrastructure Arm
        {
            //// Variable
            {
                ...
                [fieldAnglePath stroke];
                {
                    ...
                    UIFont* fieldAngleFont = [UIFont fontWithName: @"AvenirNext-Medium" size: 16];
                    [secondaryStroke setFill];
                    CGFloat fieldAngleTextHeight = [textContent sizeWithFont: fieldAngleFont constrainedToSize: CGSizeMake(CGRectGetWidth(fieldAngleRect), INFINITY) lineBreakMode: UILineBreakModeWordWrap].height;
                    CGContextSaveGState(context);
                    CGContextClipToRect(context, fieldAngleRect);
                    [textContent drawInRect: CGRectMake(CGRectGetMinX(fieldAngleRect), CGRectGetMinY(fieldAngleRect) + (CGRectGetHeight(fieldAngleRect) - fieldAngleTextHeight) / 2, CGRectGetWidth(fieldAngleRect), fieldAngleTextHeight) withFont: fieldAngleFont lineBreakMode: NSLineBreakByWordWrapping alignment: NSTextAlignmentCenter];
                    CGContextRestoreGState(context);
                }
                ...
                CGRect rectangle111Rect = CGRectMake(142, 122, 52, 25);
                {
                    ...
                    UIFont* rectangle111Font = [UIFont fontWithName: @"AvenirNext-Medium" size: 16];
                    [secondaryStroke setFill];
                    CGFloat rectangle111TextHeight = [textContent sizeWithFont: rectangle111Font constrainedToSize: CGSizeMake(CGRectGetWidth(rectangle111Rect), INFINITY) lineBreakMode: UILineBreakModeWordWrap].height;
                    CGContextSaveGState(context);
                    CGContextClipToRect(context, rectangle111Rect);
                    [textContent drawInRect: CGRectMake(CGRectGetMinX(rectangle111Rect), CGRectGetMinY(rectangle111Rect) + (CGRectGetHeight(rectangle111Rect) - rectangle111TextHeight) / 2, CGRectGetWidth(rectangle111Rect), rectangle111TextHeight) withFont: rectangle111Font lineBreakMode: NSLineBreakByWordWrapping alignment: NSTextAlignmentCenter];
                    CGContextRestoreGState(context);
                }
            }
